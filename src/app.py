...
#Jmodel = pickle.load(open('G:/PROJECT FARM/Crop-Price-Prediction-Using-Random-Forest/src/jmodel.pkl', 'rb'))
Jmodel = pickle.load(open(r'G:/PROJECT FARM/Crop-Price-Prediction-Using-Random-Forest/src/jmodel.pkl', 'rb'))

Wmodel = pickle.load(open(r'G:/PROJECT FARM/Crop-Price-Prediction-Using-Random-Forest/src/wmodel.pkl','rb'))
Cmodel = pickle.load(open(r'G:/PROJECT FARM/Crop-Price-Prediction-Using-Random-Forest/src/cmodel.pkl','rb'))
Smodel = pickle.load(open(r'G:/PROJECT FARM/Crop-Price-Prediction-Using-Random-Forest/src/smodel.pkl','rb'))
Bmodel = pickle.load(open(r'G:/PROJECT FARM/Crop-Price-Prediction-Using-Random-Forest/src/bmodel.pkl','rb'))
preprocessor = pickle.load(open(r'G:/PROJECT FARM/Crop-Price-Prediction-Using-Random-Forest/src/preprocessor.pkl','rb'))
